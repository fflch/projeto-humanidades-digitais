...
<!--////////////////FalseHeader, white////////////////-->
  ...
  <div class="dropdown-long">
    <div class="falsebutton-long">
              ...
              <i class="false"></i>
              <i class="arrow left" onclick="Toggle()" title="Recolher"></i>
              <i class="arrow right" onclick="Toggle()" title="Mostrar"></i>
...
<div id="Ficha-header">
    ...
    <em><xsl:value-of select="Data[@name='Voz']"/></em>
    <br/>
    <br/>
    <em><xsl:value-of select="Data[@name='Nomeação']"/></em>
    <br/>
    <br/>
...
<!--/////////////////////////Descrição/////////////////////////-->
    ...
    <div id="Ficha-2" class="Ficha-transp">
      ...
      <!--Resuminho-->
      <!--(um para cada doc:)-->
      <!--Antigo: [Estado do documento primário]; [Tipo do documento], escrito em [Ano do documento], arquivado em [Arquivo].-->
      <br/>
      <br/>
      <br/>
      
      <xsl:value-of select="Data[@name='Estado do documento primário']"/><!--<xsl:value-of select="Data[@name='Tipo de documento']"/><xsl:text>, </xsl:text><xsl:value-of select="Data[@name='Ano do documento']"/><xsl:text>, </xsl:text><xsl:value-of select="Data[@name='Arquivo']"/><xsl:text>.</xsl:text>-->
        ...
        <xsl:choose><!--Haver ou não dois documentos: -->
            ...
            <br/>
            <xsl:value-of select="Data[@name='Estado do documento primário, segundo documento']"/> (segundo documento, <xsl:value-of select="Data[@name='Ano do documento, segundo documento']"/>).<!--<xsl:value-of select="Data[@name='Tipo de documento, segundo documento']"/><xsl:text>, </xsl:text><xsl:value-of select="Data[@name='Ano do documento, segundo documento']"/><xsl:text>, </xsl:text><xsl:value-of select="Data[@name='Arquivo, segundo documento']"/><xsl:text>.</xsl:text>-->
        ...
        <xsl:choose><!--Haver ou não 3 documentos: -->
            ...
            <xsl:value-of select="Data[@name='Estado do documento primário, terceiro documento']"/> (terceiro documento, <xsl:value-of select="Data[@name='Ano do documento, terceiro documento']"/>). <!--<xsl:value-of select="Data[@name='Tipo de documento, terceiro documento']"/><xsl:text>, </xsl:text><xsl:value-of select="Data[@name='Ano do documento, terceiro documento']"/><xsl:text>, </xsl:text><xsl:value-of select="Data[@name='Arquivo, terceiro documento']"/><xsl:text>.</xsl:text>-->
...
<!--/////////////////////////Transcrição//////////////////////-->
        ...
        <div id="Ficha-3" class="Ficha-white">
    ...
    <div id="Ficha-4" class="Ficha-white">
        ...
        <br/>
          ...
          <xsl:element name="a">
            <xsl:attribute name="href"><xsl:value-of select="normalize-space(Data[@name='URL da fonte, segundo documento'])"/></xsl:attribute>
            <xsl:attribute name="class">wraplink</xsl:attribute>
            <xsl:attribute name="Target">_blank</xsl:attribute>
            <xsl:attribute name="title">Abrir segundo documento no repositório original</xsl:attribute>
        <xsl:value-of select="Data[@name='URL da fonte, segundo documento']"/>
         ...
         <xsl:choose><!--Haver ou não 3 documentos -->
          ...
          <xsl:value-of select="Data[@name='Indexador na fonte, segundo documento']"/>. <xsl:text> </xsl:text>
          <xsl:element name="a">
            <xsl:attribute name="href"><xsl:value-of select="normalize-space(Data[@name='URL da fonte, segundo documento'])"/></xsl:attribute><xsl:attribute name="class">wraplink</xsl:attribute><xsl:attribute name="Target">_blank</xsl:attribute><xsl:attribute name="title">Abrir segundo documento no repositório original</xsl:attribute>
        <xsl:value-of select="Data[@name='URL da fonte, segundo documento']"/>
</xsl:element>. <span style="color: #999999;"><xsl:value-of select="Data[@name='Código, segundo documento']"/></span>.
          <br/>
          <br/>
          ...
          <xsl:element name="a">
            <xsl:attribute name="href"><xsl:value-of select="normalize-space(Data[@name='URL da fonte, terceiro documento'])"/></xsl:attribute><xsl:attribute name="class">wraplink</xsl:attribute><xsl:attribute name="Target">_blank</xsl:attribute><xsl:attribute name="title">Abrir terceiro documento no repositório original</xsl:attribute>
...
<!--OBS: Div Ficha-5 construída apenas se houver menção-->  
    ...
    <div id="Ficha-5" class="Ficha-white">    
        <h2>Menção em documentos secundários</h2>
    
          <xsl:value-of select="Data[@name='Fonte da menção na bibliografia']"/>:
        <br/>
        <br/>
          <em><xsl:value-of select="Data[@name='Trecho de menção na bibliografia']"/></em>
...
<!--/////////////////////////Dados Bio//////////////////////////--> 
    ...
    <div id="Ficha-6" class="Ficha-white">
...
<!--///////////////////Dados Internos/////////////////-->
    ...
    <div id="Ficha-7" class="Ficha-white">
