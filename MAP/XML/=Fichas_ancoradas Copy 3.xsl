...
<xsl:template match="Placemark">
  ...
  <div class="Ficha-wrap">
    ...
    <div class="Ficha-cell" id="Ficha-cell-1" style="">
    ...
    <div class="Ficha-cell" id="Ficha-cell-2" style="">
  ...
  <xsl:otherwise><!--Se não autora -->
     ...
     <div class="Ficha-cell" id="Ficha-cell-3" style="">
     ...
     <div class="Ficha-cell" id="Ficha-cell-4" style="">    
     ...
     <!--was td colspan2-->
    <div class="Ficha-cell" id="Ficha-cell-5" style="">
    ...
    <div class="Ficha-cell" id="Ficha-cell-6" style="">
        
        <h2><xsl:text>Documentos primários:</xsl:text></h2>
    ...
    <div class="Ficha-cell" id="Ficha-cell-7" style="">
