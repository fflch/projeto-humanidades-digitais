...
<xsl:template match="/">
 ...
 <div id="Main" class="Main-MAP-white">
  ...
  <!--teste-->
  	...
  	<table class="TableDropdown">
	
	<tr>		
	<td>
<div class="DropdownNavbar-inEntry" style="margin-top: 40px;"> 
  
   <xsl:element name="a">
        <xsl:attribute name="name">Nomeadas</xsl:attribute>
        
   </xsl:element>
  
  <div class="dropdown-inEntry">
    
    <div class="falsebutton-inEntry">
			<a href="">Nomes:
			<i class="arrow down"></i>
			</a>
    </div>
        <div class="dropdown-content-inEntry" style="background: rgba(255,255,255);">  
  ...
  <!--teste-->
      ...
      <xsl:element name="a">
        <xsl:attribute name="href">#Nomeadas</xsl:attribute>
        <h1>Nomeadas em documento primário</h1>
       </xsl:element>
      ...
      <xsl:element name="a">
        <xsl:attribute name="href">#Autoras</xsl:attribute>
        <h1>Autoras</h1>
       </xsl:element>
...
<div class="DropdownNavbar-inEntry" style="margin-top: 40px;"> 
   ...
   <xsl:element name="a">
        <xsl:attribute name="name">Autoras</xsl:attribute>
...
<xsl:template match="Placemark">
  ...
  <div class="Ficha" style="padding-top: 10px; width: 80vw;">      
      ...
      <br/>
      <h1><xsl:value-of select="preceding-sibling::name"/></h1>
      <p><xsl:value-of select="Data[@name='Descrição']"/></p>
      
      
  <table class="CatalogTable-Ficha" style="border: 1px solid #cccccc; padding: 5px; width: 80vw;">
  <tbody>
  ...
  <tr>
    <td style="vertical-align: text-top; width: 40%;">
      ...
      <xsl:choose><!--haver ou não imagem-->
          ...
          <div style="color: #999999; text-align: center; height: 250px; padding-top: 150px; border: 1px solid #cccccc;"><em>(sem imagem)</em></div>
          </xsl:when>
          ...
          <xsl:otherwise><!--Se houver imagem-->
            ...
            <xsl:attribute name="src">
              <xsl:value-of select="Data[@name='Imagem']"/>
            </xsl:attribute>
    ...
    (<xsl:value-of select="Data[@name='Ano do documento']"/>)
        ...
        <br/>
        <br/>
        <em><xsl:value-of select="Data[@name='Voz no segundo documento']"/></em>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        <em><xsl:value-of select="Data[@name='Voz no terceiro documento']"/></em>
        <br/>
  ...
  <tr>
    ...
    <td style="vertical-align: text-top; padding: 5px; border-top: 1px solid #999999;">
    ...
    <td style="text-align: right; vertical-align: text-top; padding: 5px 5px 5px 15px; border-top: 1px solid #999999;">
